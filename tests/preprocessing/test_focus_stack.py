...
def test_focus_stack_on_sample(h5_path, output_dir, max_tiles=20):
    """
    Test function: Run focus stacking on up to max_tiles from a single h5 file,
    save the resulting images to output_dir using matplotlib, and print the ranking for each tile.
    """
