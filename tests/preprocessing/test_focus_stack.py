...
performs focus stacking on a subset of tiles, prints out the focal plane ranking,
and saves the resulting focus-stacked images along with the most in-focus slice 
for each tile, for comparison."""
...
def test_focus_stack_on_sample(h5_path, output_dir, max_tiles=20):
    ...
    save the resulting images to output_dir using matplotlib, and print the 
    ranking for each tile.
    """
